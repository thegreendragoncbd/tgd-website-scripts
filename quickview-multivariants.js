      ...
      var variant=variantGroupName.split('-')[1];    
        ...
        if($(`${variantGroupName} .w-radio`).length > 6){
          ...
          $(`#variants-${lcVariantGroupName} .radio-button-field.w-radio`).on("click",function(){
              ...
              $(this).style.backgroundColor="1#c1e9d4";
              ...
              $("label .w-form-formradioinput.w-form-formradioinput--inputType-custom.radio-button.w-radio-input.w--redirected-checked").css("background-color","#c1e9d4");
            }, 100);

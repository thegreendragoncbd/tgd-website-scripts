  ...
  (function () {
    ...
    function buildVariantItemsList(elementID) {
      ...
      $(variants_item).each(function () {
        ...
        const itemCertification = $(this)[$(this).findIndex(".foxy_variants_item-certification-link")].getAttribute("href");
        const wholesale = {
    ...
    function buildProductItemList(elementID) {
      ...
      $(item_info).each(function () {
        ...
        const restrictedShipping = $(this).find(".foxy_variants_item-restricted-shipping").text();
        const itemCertification = $(this)[$(this).findIndex(".foxy_variants_item-certification-link")].getAttribute("href")
          ? $(this)[$(this).findIndex(".foxy_variants_item-certification-link")].getAttribute("href")
          : "none";
        const wholesale = {
